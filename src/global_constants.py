...
industry_numeric_ids = dict(coal_mine = 0,
                            ...
                            foundry = 81,
                            wharf = 82,
                            fertiliser_factory = 83,
                            factory = 84,
                            herding_coop = 85,
                            soda_ash_mine = 86,
                            distillery = 87,
                            chlor_alkali_plant = 88,
                            bakery = 89,
                            cannery = 90,
                            detergent_factory = 91,
                            sulphur_mine = 92,
                            acid_plant = 93,
                            printing_works = 94)
...
tile_numeric_ids = dict(printing_works_tile_1 = 117,
                        acid_plant_tile_1 = 118,
                        acid_plant_tile_2 = 119,
                        sulphur_mine_tile_1 = 120,
                        sulphur_mine_tile_2 = 121,
                        cannery_tile_1 = 122,
                        detergent_factory_tile_1 = 123,
                        chlor_alkali_plant_tile_1 = 124,
                        chlor_alkali_plant_tile_2 = 125,
                        bakery_tile_1 = 126,
                        distillery_tile_1 = 127,
                        distillery_tile_2 = 128,
                        fertiliser_factory_tile_1 = 129,
                        solvay_plant_tile_1 = 130,
                        wharf_tile_1 = 131,
                        wharf_tile_2 = 132,
                        ...
                        salt_mine_tile_1 = 139,
                        salt_mine_tile_2 = 140,
                        factory_tile_1 = 141,
