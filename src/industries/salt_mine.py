...
industry = IndustryPrimaryExtractive(id='salt_mine',
...
industry.add_tile(id='salt_mine_tile_2',
                  animation_length=71,
                  animation_looping=True,
                  animation_speed=2,
                  location_checks=TileLocationChecks(require_effectively_flat=True,
...
industry.add_industry_layout(
    ...
    layout=[(0, 0, 'salt_mine_tile_2', 'salt_mine_spritelayout_crusher_rear_part'),
...
industry.add_industry_layout(
    ...
    layout=[(0, 0, 'salt_mine_tile_1', 'salt_mine_spritelayout_headgear_animated'),
