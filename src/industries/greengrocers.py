...
industry = IndustryTertiary(id='greengrocers',
                            accept_cargo_types=['FRUT', 'TATO'],
                            prod_cargo_types=[],
                            prob_in_game='12',
                            prob_random='24',
                            prod_multiplier='[0, 0]',
                            ...
                            name='string(STR_IND_GREENGROCERS)',
...
industry.add_tile(id='greengrocers_tile_1',
...
industry.add_spritelayout(
    id='greengrocers_spritelayout',
    ground_sprite=spriteset_ground,
    ground_overlay=spriteset_ground_overlay,
    building_sprites=[spriteset_1, sprite_tree_1, sprite_tree_2]
)
industry.add_industry_layout(
    id='greengrocers_industry_layout',
    layout=[(0, 0, 'greengrocers_tile_1', 'greengrocers_spritelayout')]
)
